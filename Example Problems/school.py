def open_school(covid, school, tuition):   
    ...
    elif covid or school or tuition:  # if covid is true, school is true and tuition is true
        return ('SCHOOL IS CLOSED FOR IN PERSON INSTRUCTION. PLEASE STAY HOME FOR ONLINE LEARNING')  # To print this statement
...
print(open_school(True, True, True))  # To print this to call the function 'open_school'
